...
par(mfrow=c(2,2))
# Boston
plot(power.table.boston$p, power.table.boston$tvhat_search, pch=19, xlab="p", ylab="tv",main="Boston",type="b", cex = 0.7, font.main=2)
points(power.table.boston$p,pmax(0, power.table.boston$tvhat_binomial), pch=19,col="red",type="b")
# titanic
plot(power.table.titanic$p, power.table.titanic$tvhat_search, pch=19, xlab="p", ylab="tv",main="Titanic", type="b", cex = 0.7, font.main=2)
points(power.table.titanic$p,pmax(0, power.table.titanic$tvhat_binomial), pch=19,col="red", type="b")

plot(power.table.breast$p, power.table.breast$tvhat_search, pch=19, xlab="p", ylab="tv",main="Breast Cancer", type="b", cex = 0.7, font.main=2)
points(power.table.breast$p,pmax(0, power.table.breast$tvhat_binomial), pch=19,col="red", type="b")

plot(power.table.iono$p, power.table.iono$tvhat_search, pch=19, xlab="p", ylab="TV",main="Ionosphere", type="b", cex = 0.7, font.main=2)
