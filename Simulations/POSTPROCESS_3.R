...
par(mfrow=c(2,2))
plot(power.table[m==0.5,]$tvhat_search,pch=19, xlab="p", ylab="tv")
points(pmax(0, power.table[m==0.5,]$tvhat_binomial),pch=19,col="red")

plot(power.table[m==2,]$tvhat_search,pch=19, xlab="p", ylab="tv")
points(pmax(0, power.table[m==2,]$tvhat_binomial),pch=19,col="red")

plot(power.table[m==4,]$tvhat_search,pch=19, xlab="p", ylab="tv")
points(pmax(0, power.table[m==4,]$tvhat_binomial),pch=19,col="red")

plot(power.table[m==10,]$tvhat_search,pch=19, xlab="p", ylab="tv")
