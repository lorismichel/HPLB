...
for (i in 1:4) {
  for (j in i:4) {
    if (i != j) {
      ordering.array[j,i,] <- -ordering.array[i,j,]
    }
  }
}
...
tv.mat.air <- getTvLbDistanceMatrix(labels = labels, ordering.array = ordering.array)
print(tv.mat.air)


## prate only analysis
dat <- data.frame(class=tenyears.ind, x = cbind(t(prate)))
...
source("./R/invertBinMeanTest.R")
source("./R/getTvLbDistanceMatrix.R")
tv.mat.prate <- getTvLbDistanceMatrix(labels = labels, ordering.array = ordering.array)
print(tv.mat.prate)


## shum only analysis
dat <- data.frame(class=tenyears.ind, x = cbind(t(shum)))
...
source("./R/invertBinMeanTest.R")
source("./R/getTvLbDistanceMatrix.R")
tv.mat.shum <- getTvLbDistanceMatrix(labels = labels, ordering.array = ordering.array)
print(tv.mat.shum)
...
source("./R/invertBinMeanTest.R")
source("./R/getTvLbDistanceMatrix.R")
tv.mat.mslp <- getTvLbDistanceMatrix(labels = labels, ordering.array = ordering.array)
print(tv.mat.mslp)
...
source("./R/invertBinMeanTest.R")
source("./R/getTvLbDistanceMatrix.R")
tv.mat.joint <- getTvLbDistanceMatrix(labels = labels, ordering.array = ordering.array)
print(tv.mat.joint)
